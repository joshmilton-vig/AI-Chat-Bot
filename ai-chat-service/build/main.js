...
var VividAssistant = (() => {
  ...
  var W = (e, t) => {
      for (var i in t) T(e, i, { get: t[i], enumerable: !0 });
    },
    J = (e, t, i, r) => {
      if ((t && typeof t == "object") || typeof t == "function")
        for (let n of F(t))
          !G.call(e, n) &&
            ...
            T(e, n, {
              get: () => t[n],
              enumerable: !(r = R(t, n)) || r.enumerable,
            });
      return e;
    };
  var Y = (e) => J(T({}, "__esModule", { value: !0 }), e);
  var ae = {};
  W(ae, { mountVividChat: () => ne });
  async function _(e, t, i, r) {
    let n = await fetch(`${e}/chat`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ business: t, messages: i }),
      signal: r,
    });
    if (!n.ok) {
      let C = await n.text().catch(() => "");
      throw new Error(`Chat error ${n.status}: ${C || n.statusText}`);
    }
    let b = await n.json();
    return String(b.message ?? "Sorry \u2014 I couldn\u2019t get a response.");
  }
  var N = "vivid-chat-style",
    a = "vivid-chat-widget",
    z = "vivid-chat-host",
    H = null;
  function A() {
    ...
    return (
      ...
      (H = e.shadowRoot ?? e.attachShadow({ mode: "open" })),
      { host: e, shadow: H }
    );
  }
  function q(e) {
  ...
  `,
    ...
    (n.id = N), (n.textContent = r), t.appendChild(n);
  }
  function Q(e) {
    return e || "vivid_chat_session";
  }
  function U(e) {
    try {
  ...
  function X(e, t) {
    try {
      localStorage.setItem(e, JSON.stringify(t.slice(-50)));
    } catch {}
  }
  function D(e) {
    try {
  ...
  function K(e = {}) {
    let t = {
      ...
      i = t.apiBase ?? "/api/ai",
      r = t.business ?? ee(),
      n = t.siteName ?? (document.title || "Vivid Store"),
      b = !!t.debug,
      C = {
        "--va-primary": t.theme?.primary || "#111",
        "--va-surface": t.theme?.surface || "#fff",
        "--va-text": t.theme?.text || "#111",
        "--va-assistant-bubble": t.theme?.assistantBubble || "#f6f6f7",
        "--va-user-text": t.theme?.userText || "#fff",
        "--va-header-bg": t.theme?.headerBg || "#fff",
        "--va-header-text": t.theme?.headerText || "#111",
        "--va-bubble": t.theme?.bubbleColor || t.theme?.primary || "#111",
      },
      { shadow: j } = A();
    q(C);
    let x = !1,
    ...
    (f.className = "bubble"),
      (f.title = "Chat"),
      (f.innerHTML = t.iconSVG || Z());
    let l = document.createElement("div");
    l.className = "panel";
    let y = document.createElement("header"),
      I = document.createElement("div");
    I.textContent = t.title || "Vivid Assistant";
    let $ = document.createElement("div");
    ($.className = "brand"), ($.textContent = n);
    ...
    g.placeholder = "Ask about products, lead times, shipping, etc.";
    ...
    (E.className = "hint"),
      ...
      j.appendChild(v);
    function k(s) {
      if (((x = s), l.classList.toggle("open", x), x && t.welcomeMessage)) {
        let o = "vivid_chat_welcome_shown";
        (!t.welcomeOnce || !D(o)) &&
          (m("assistant", t.welcomeMessage), t.welcomeOnce && V(o));
      }
    }
    f.addEventListener("click", () => k(!x)),
      w.addEventListener("click", () => k(!1));
    let B = Q(t.storageKey),
      c = (t.persist && U(B)) || [{ role: "system", content: te(n, r) }];
    if (c.length && c[0].role === "system")
      for (let s of c.slice(1)) m(s.role, s.content);
    function S() {
      t.persist && X(B, c);
    }
    async function L() {
      ...
      if (s) {
        ...
        try {
          ...
          (p.style.display = "none"),
            d && (d.disabled = !1),
            c.push({ role: "assistant", content: o }),
            m("assistant", o),
            S(),
            P("vivid_chat_message", { role: "assistant" });
        } catch (o) {
          (p.style.display = "none"), d && (d.disabled = !1);
          let h = `Sorry \u2014 I had trouble reaching the assistant. (${
            o?.message || "Network error"
          })`;
          c.push({ role: "assistant", content: h }),
            m("assistant", h),
            S(),
            b && console.error(o);
        }
    ...
    function P(s, o) {
      (window.dataLayer = window.dataLayer || []),
        window.dataLayer.push({ event: s, ...o, business: r, siteName: n });
    }
    if (
      (b &&
      ...
      typeof t.autoOpenDelay == "number")
    ) {
      let s = "vivid_chat_auto_open_done";
      (!t.autoOpenOnce || !D(s)) &&
        setTimeout(() => {
          k(!0), t.autoOpenOnce && V(s);
        }, Math.max(0, t.autoOpenDelay));
    }
  }
  function Z() {
  ...
  function ee() {
    ...
    return e.includes("vividnola")
      ? "vividnola"
      : e.includes("toastedyolk")
      ? "toastedyolk"
      : e.includes("celtic")
      ? "celtic"
      : "vivid";
  ...
  function te(e, t) {
    return [
      `You are Prisma storefront assistant for ${e} (business: ${t}).`,
...
`);
  ...
  function ne(e) {
    let t = e?.apiBase ?? "https://assistant.vivid-think.com/api/ai",
      i = () => K({ ...e, apiBase: t });
