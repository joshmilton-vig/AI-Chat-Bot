...
// ⬇️ Mount the catalog routes implemented in frontend/src/routes/catalog.ts
// NOTE: If your folder layout differs, adjust this import path accordingly.
import { mountCatalogRoutes } from "../frontend/src/routes/catalog";
...
app.set("etag", false); // avoid 304 revalidation on JSON
...
const corsOptions: cors.CorsOptions = {
  ...
  // ⬇️ include Cache-Control to satisfy preflight when browsers send it
...
// ---------- Catalog Routes (products + product detail) ----------
